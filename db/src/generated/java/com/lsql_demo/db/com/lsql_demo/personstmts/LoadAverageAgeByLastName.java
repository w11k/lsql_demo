...
public final class LoadAverageAgeByLastName implements com.w11k.lsql.TableRow, Last_Name_String, Age_Integer {
    ...
    public static LoadAverageAgeByLastName fromInternalMap(java.util.Map<String, Object> internalMap) {
        return new LoadAverageAgeByLastName((java.lang.String) internalMap.get("last_name"), (java.lang.Integer) internalMap.get("age"));
    }

    @SuppressWarnings("unused")
    public static LoadAverageAgeByLastName fromMap(java.util.Map<String, Object> map) {
        return new LoadAverageAgeByLastName((java.lang.String) map.get("lastName"), (java.lang.Integer) map.get("age"));
    }
